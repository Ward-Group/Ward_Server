...
public class WebCrawlingUtil {
    ...
    public List<String> getPage() {
        ...
        List<WebElement> elements = driver.findElements(By.cssSelector(".product-card.ncss-row.mr0-sm.ml0-sm"));
        for (WebElement parent : elements) {
            String month = parent.findElement(By.cssSelector(".launch-caption .headline-4")).getText();
            String day = parent.findElement(By.cssSelector(".launch-caption .headline-1")).getText();
            String productName = parent.findElement(By.cssSelector(".figcaption-content .headline-5")).getText();
            WebElement imgElement = parent.findElement(By.cssSelector("div.ncss-col-sm-12 a.card-link img.image-component"));
            String imgUrl = imgElement.getAttribute("src");
            results.add(month + " " + day + "," + productName + ", url=" + imgUrl);
        }
        return results;
    }

    public List<WebProductData> getPageWithJSoup() {
