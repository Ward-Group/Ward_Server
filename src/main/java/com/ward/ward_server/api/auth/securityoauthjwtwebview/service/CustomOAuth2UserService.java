package com.ward.ward_server.api.auth.securityoauthjwtwebview.service;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (existData == null) {
            ...
            UserEntity userEntity = UserEntity.createUser(username, oAuth2Response.getName(), oAuth2Response.getEmail());
